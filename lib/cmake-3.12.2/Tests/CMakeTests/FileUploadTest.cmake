file(REMOVE_RECURSE "/home/user/cmake-3.12.2/Tests/CMakeTests/uploads")

if(EXISTS "/home/user/cmake-3.12.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/user/cmake-3.12.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/user/cmake-3.12.2/Tests/CMakeTests/uploads")

set(filename "/home/user/cmake-3.12.2/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/user/cmake-3.12.2/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/user/cmake-3.12.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/user/cmake-3.12.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/user/cmake-3.12.2/Tests/CMakeTests/uploads/file2.png"
